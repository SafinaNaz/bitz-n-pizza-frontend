import { BAKE_PIZZA, GET_ERRORS, BEFORE_BAKE_PIZZA, BAKED_PIZZAS, UNBAKE_PIZZA, REBAKE_PIZZA_INGREDIENTS, REBAKED_PIZZA, RANDOM_PIZZA, GET_PIZZA } from "../../redux/types";
...
export const getBakedPizzas = (qs = '') => dispatch => {
    dispatch(emptyError());
...
// create pizza api call
export const randomBakePizza = (payload) => dispatch => {
    dispatch(emptyError())
...
export const getBakedPizzasByUser = (qs = '', body = {}) => dispatch => {
    dispatch(emptyError());
